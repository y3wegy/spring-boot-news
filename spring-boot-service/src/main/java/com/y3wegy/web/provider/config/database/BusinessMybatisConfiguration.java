...
import com.y3wegy.web.provider.config.database.helper.MyBatiesConfigHelper;
 ...
 */
@Configuration
@MapperScan(basePackages = {"com.y3wegy.web.provider.mapper.business"}, sqlSessionFactoryRef = "businessSqlSessionFactory")
