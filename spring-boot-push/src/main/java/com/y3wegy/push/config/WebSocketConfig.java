package com.y3wegy.push.config;
...
import com.y3wegy.push.handler.PrincipalHandshakeHandler;
import com.y3wegy.push.interceptor.WebSocketChannelInterceptor;
import com.y3wegy.push.interceptor.WebSocketHandshakeInterceptor;
...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
    ...
    public void registerStompEndpoints(StompEndpointRegistry stompEndpointRegistry) {
        ...
        /**
         * 1. 将 {@link PushConstants.ENDPOINT },{@link PushConstants.ENDPOINT2 }路径注册为STOMP的端点，
         *    用户连接了这个端点后就可以进行websocket通讯，支持socketJs
         * 2. setAllowedOrigins("*")表示可以跨域
         * 3. withSockJS()表示支持socktJS访问
         * 4. addInterceptors 添加自定义拦截器，这个拦截器是自己定义的获取httpsession的拦截器
         * 5. setHandshakeHandler 添加拦截处理，这里MyPrincipalHandshakeHandler 封装的认证用户信息
         */
        stompEndpointRegistry.addEndpoint(PushConstants.ENDPOINT, PushConstants.ENDPOINT2)
                .setAllowedOrigins("*")
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry) {
        ...
        /**
         * spring 内置broker对象
         * 1. 配置代理域，可以配置多个，此段代码配置代理目的地的前缀为{@link PushConstants.TOPIC1}{@link PushConstants.TOPIC2}
         *    我们就可以在配置的域上向客户端推送消息
         ...
         */
        registry.enableSimpleBroker(PushConstants.TOPIC1,PushConstants.TOPIC2)
                .setHeartbeatValue(new long[]{10000, 10000})
                .setTaskScheduler(taskScheduler);
        /**
         *  {@link PushConstants.APP_PREFIX} 为配置应用服务器的地址前缀，表示所有以 {@link PushConstants.APP_PREFIX} 开头的客户端消息或请求
         *  都会路由到带有@MessageMapping 注解的方法中
         */
        registry.setApplicationDestinationPrefixes(PushConstants.APP_PREFIX);
         ...
         */
        registry.setUserDestinationPrefix(PushConstants.USER_PREFIX);
