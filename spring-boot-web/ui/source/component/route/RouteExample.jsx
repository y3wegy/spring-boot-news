        ...
        return (
            <div>
                <ul>
                    ...
                    <li><Link to={`${match.path}/PreventTransition`}>Prevent Transition</Link></li>
                ...
                <Switch>
                    ...
                    <Route path={`${match.path}/Protected`} component={RedirectRouteExample}/>
                    <Route path={`${match.path}/PreventTransition`} component={PreventTransition}/>
