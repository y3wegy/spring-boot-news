...
module.exports = {
        ...
        test: /\.(png|ico|gif|jpe?g)(\?[a-z0-9]+)?$/, use: [
          {
            loader: 'url-loader',
            options: {
              limit: 8192,//<limit  use base64 ,otherwise file-loader
  ...
  plugins: [
    ...
    new CleanWebpackPlugin({
      ...
      //   Not included in rebuilds (watch mode) ,Use !negative patterns to exclude files
      cleanOnceBeforeBuildPatterns: ['**/*', '!static-files*', '!/error'],
      //exclude: ['/error'],
